...
namespace Entidades
{
    ...
    public class Grupo : IEntradaSalida<GrupoDao>
    {
        ...
        //Validar en el operator + que si el grupo ya cuenta con el máximo de equipos (atributo maxCantidad), 
        //se lance la excepción propia GrupoLlenoException con el mensaje "El Grupo {0} ya cuenta con {1} equipos", 
        //siendo {0} la letra del grupo y {1} la cantidad máxima
        public static Grupo operator +(Grupo g, Equipo e)
        {
            ...
            if (g.equipos.Count < g.maxCantidad)
                ...
                throw new GrupoLlenoException(String.Format("El Grupo '{0}' ya cuenta con '{1}' equipos", g.grupo, g.equipos.Count));
        ...
        /// </summary>
        /// <returns></returns>
        /// El método MostrarTabla deberá ordenar los datos antes de mostrarlos utilizando el método Ordenar.
        public string MostrarTabla()
        {
            //SORT utiliza un metodo comparador
        ...
        //Tomará de la base de datos todos los equipos del Grupo que esta instancia represente.
        //Cargará la lista de equipos.
        public GrupoDao Leer()
        {
            throw new NotImplementedException();
        }

        public GrupoDao Guardar()
        {
